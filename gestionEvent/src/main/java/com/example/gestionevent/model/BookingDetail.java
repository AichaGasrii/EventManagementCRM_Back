...
public class BookingDetail implements Serializable {
	...
	public BookingDetail(int venueId, String userName, int bookingId, Date date, int guestCount, String eventName,
	...
	public String toString() {
		return "BookingDetail [venueId=" + venueId + ", userName=" + userName + ", bookingId=" + bookingId + ", date="
